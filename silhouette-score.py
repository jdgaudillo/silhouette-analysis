...
def analysis(X):
    ...
    for n_clusters in range_n_clusters:
        ...
        cluster_labels = clusterer.fit_predict(X)
       	...
       	outfile = 'silhouette-coefficients-' + str(n_clusters) +'.csv'
       	np.savetxt(outfile, silhouette_samples(X, cluster_labels), delimiter=',')
...
X = pd.read_csv(file, encoding="ISO-8859-1", dtype = dcols, usecols= cols,nrows=30000)
print('Read file!')
